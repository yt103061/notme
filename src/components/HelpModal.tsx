...
// 強い順の役一覧と実例。CATEGORY_LABELS のインデックスは弱い順なので逆順で参照する
const HAND_EXAMPLES: { category: number; cards: Card[] }[] = [
  { category: 8, cards: [c('S', 9), c('S', 8), c('S', 7), c('S', 6), c('S', 5)] },
  { category: 7, cards: [c('S', 7), c('H', 7), c('D', 7), c('C', 7), c('S', 13)] },
  { category: 6, cards: [c('S', 12), c('H', 12), c('D', 12), c('C', 4), c('S', 4)] },
  { category: 5, cards: [c('H', 14), c('H', 11), c('H', 8), c('H', 6), c('H', 3)] },
  { category: 4, cards: [c('S', 8), c('H', 7), c('D', 6), c('C', 5), c('S', 4)] },
  { category: 3, cards: [c('S', 9), c('H', 9), c('D', 9), c('C', 14), c('S', 5)] },
  { category: 2, cards: [c('S', 11), c('H', 11), c('D', 6), c('C', 6), c('S', 12)] },
  { category: 1, cards: [c('S', 10), c('H', 10), c('D', 14), c('C', 7), c('S', 3)] },
